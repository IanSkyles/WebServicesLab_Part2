...
public class CourseAddFragment extends Fragment {
    ...
    private final static String COURSE_ADD_URL = "http://cssgate.insttech.washington.edu/~iskyles/Android/addCourse.php?";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCourseShortDescEditText = (EditText) v.findViewById(R.id.add_couurse_short_desc);
